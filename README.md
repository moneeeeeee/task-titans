...
- [How to Build a RESTful API with Node and Express](https://www.digitalocean.com/community/tutorials/how-to-build-a-restful-api-with-node-js-express-and-mongodb)
